...
namespace COMP003A.LectureActivity7
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // array2 declaration with value
            int[] array2 = new int[] { 1, 3, 5, 7, 9 }; // declares a single-dimensional array element with value

            /* arrays are zero-indexed, meaning the first 'position' starts at index 0
             * values in an array can be accesed using the syntax below:
             ...
             * Also, you will get a runtime error of OutofBoundsExeception
            ...
            Console.WriteLine("\nstring Traversal");
            // string are special object consisting of an array of characters
            ...
            // listName[indexNumber] to accesss a specific content in the collection
            Console.WriteLine($"alphabet[0]: {alphabet[0]}");
            Console.WriteLine($"alphabet[2]: {alphabet[2]}");
            Console.WriteLine($"alphabet[4]: {alphabet[4]}");

            alphabet.Remove('C'); // removes specific value somewhere inside the collection
        ...
        /// Array travseral
        /// </summary>
        /// <param name="array">Integer array to traversal</param>
